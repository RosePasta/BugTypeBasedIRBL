 ...
 * to be aware of {@link Container}s and {@link ContainerStatus}s.
 *
...
public interface ContainerAware {
	 ...
	 * about a {@link Container}s.
	 *
	 * @param containers the containers
	 */
	void onContainer(List<Container> containers);

	/**
	 * Called when we potentially have new information
	 * about a {@link ContainerStatus}s.
	 *
	 * @param containerStatuses the container statuses
	 */
	void onContainerStatus(List<ContainerStatus> containerStatuses);
