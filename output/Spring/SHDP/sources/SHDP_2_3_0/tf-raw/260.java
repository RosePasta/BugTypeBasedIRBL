...
public class NormalAnnotationConfigurationTests {
	...
	public void testSimpleConfig() throws Exception {
		assertNotNull(ctx);
		assertTrue(ctx.containsBean(YarnSystemConstants.DEFAULT_ID_CONFIGURATION));
		YarnConfiguration config = ctx.getBean(YarnSystemConstants.DEFAULT_ID_CONFIGURATION, YarnConfiguration.class);
