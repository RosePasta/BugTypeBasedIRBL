...
public class AbstractLocalTransition <S, E> extends AbstractTransition<S, E> implements Transition<S, E> {
	...
	public AbstractLocalTransition(State<S, E> source, State<S,E> target,Collection<Action> actions, E event) {
		super(source, target, actions, event, TransitionKind.LOCAL);
	}
