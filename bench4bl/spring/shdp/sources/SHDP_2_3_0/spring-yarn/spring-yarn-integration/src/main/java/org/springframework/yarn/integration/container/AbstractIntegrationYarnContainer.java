 ...
 * {@link AbstractYarnContainer} to handle
...
public abstract class AbstractIntegrationYarnContainer extends AbstractYarnContainer {
	 ...
	 *
	 * @param integrationServiceClient the new integration service client
	 */
	public void setIntegrationServiceClient(IntegrationAppmasterServiceClient<?> integrationServiceClient) {
	 ...
	 *
	 * @return the integration service client
	 */
